...
st.set_page_config(page_title="Aravia MVP – DeepSeek 版", page_icon="🏛️", layout="wide")
st.title("🏛️ Aravia Knowledge Platform")
st.caption("CHAN Ching Kan 20年建築知識 + 2024 CUHK PhD 驅動 | DeepSeek 版（深度加強）")
...
with st.sidebar:
    st.success("✅ DeepSeek 版已連接成功！")
    st.caption("低成本 · 深度強 · Vision 好")
...
st.caption("DeepSeek 版 MVP | 由零開始全新建立 · 低成本高深度")
